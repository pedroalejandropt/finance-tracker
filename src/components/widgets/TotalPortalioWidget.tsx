...
export const TotalPortafolioWidget: React.FC<WidgetComponentProps> = ({ totals, previousTotal, baseCurrency, onCurrencyChange }) => {
    ...
    <div className="space-y-4">
        ...
        {previousTotal && (
            <div className={`flex items-center space-x-1 ${change >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                }`}>
                {change >= 0 ? (
